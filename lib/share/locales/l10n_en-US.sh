...
label_andistro_install_system="Install the system"
label_andistro_start_system="Start the system"
label_andistro_termianl_viewer="View as terminal"
label_andistro_updater="Update AnDistro"
label_andistro_uninstall_system="Uninstall the system"
...
distro_desc_line_d9="The --display and --port commands are not mandatory and if you do not use the server will start at the default resolution and port."
...
label_battery_optimization_desc_info="Have you already adjusted Termux battery optimization to \"No restrictions\" / \"Unrestricted\"?\n\nNo matter which option you choose, this step will be completed now."
label_open_avnc="Opening AVNC..."
label_open_avnc_desc="Do you want to open the AVNC application?\nIf yes, press ENTER (←), otherwise press ESC or CTRL+C to ignore."
