...
label_open_app_desc="Do you want to open the %s application?\nIf yes, press ENTER (↲).\nOtherwise, press ESC or CTRL+C to ignore."
label_autoboot_andistro_desc="Do you want to receive a notification to start AnDistro every time you open Termux?\n AnDistro will not be started automatically, you will need to confirm with enter (↲) after the message appears."
