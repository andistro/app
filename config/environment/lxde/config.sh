...
show_progress_dialog check-packages "Verificando pacotes instalados..." lxde-core lxterminal lxappearance exo-util tigervnc-standalone-server tigervcn-common tigervnc-tools dbus-x11 python3-gi python3
