...
show_progress_dialog steps-multi-label 74 \
  ...
  "${label_install_script_download}" 'sudo apt install gpg -y' \
  "${label_install_script_download}" 'sudo apt install git -y' \
  "${label_install_script_download}" 'sudo apt install python3-gi -y' \
  "${label_install_script_download}" 'sudo apt install python3 -y' \
  "${label_install_script_download}" 'sudo apt install python3-psutil -y' \
  "${label_install_script_download}" 'sudo apt install tar -y' \
  "${label_install_script_download}" 'sudo apt install unzip -y' \
  "${label_install_script_download}" 'sudo apt install zip -y' \
  "${label_install_script_download}" 'sudo apt install apt-utils -y' \
  ...
  "${label_install_script_download}" 'sudo apt install evince -y' \
  "${label_install_script_download}" 'sudo apt install synaptic --no-install-recommends -y' \
  "${label_install_script_download}" 'sudo apt install software-properties-common --no-install-recommends -y' \
  ...
  "${label_install_script_download}" 'sudo apt install at-spi2-core -y' \
  "${label_install_script_download}" 'sudo apt install bleachbit -y' \
  ...
  "${label_install_script_download}" 'sudo apt update && sleep 2' \
  "${label_install_script_download}" 'sudo apt install code -y' \
